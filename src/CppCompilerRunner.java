...
public class CppCompilerRunner {

    public CppCompilerRunner() {
    }

    public static String run(String sourceFile, String input) throws IOException, InterruptedException {
        // Step 1: Compile the C++ code using g++
        ProcessBuilder compileProcessBuilder = new ProcessBuilder("g++", sourceFile, "-o", "cppmain");
        ...
        ProcessBuilder runProcessBuilder = new ProcessBuilder("./cppmain");
